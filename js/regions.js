...
var country_arr = new Array("Вінницька обл.", "Волинська обл.", "Дніпропетровська обл.", "Донецька обл.", "Житомирська обл.", "Закарпатська обл.", "Запорізька обл.", "Івано-Франківська обл.", "Київська обл.", "Кіровоградська обл.", "Крим", "Луганська обл.", "Львівська обл.", "Миколаївська обл.", "Одеська обл.", "Полтавська обл.", "Рівненська обл.", "Сумська обл.", "Тернопільська обл.", "Харківська обл.", "Херсонська обл.", "Хмельницька обл.", "Черкаська обл.", "Чернігівська обл.", "Чернівецька обл." );

// States
var s_a = new Array();
s_a[0]="";
s_a[1]="Вінниця|Бар|Бершадь|Браїлів|Брацлав|Вапнярка|Вендичани|Вороновиця|Гайсин|Гнівань|Дашів|Жмеринка|Іллінці|Козятин|Калинівка|Крижопіль|Липовець|Літин|Могилів-Подільський|Муровані Курилівці|Немирів|Оратів|Піщанка|Погребище|Теплик|Томашпіль|Тростянець|Тульчин|Тиврів|Хмільник|Чернівці|Чечельник|Шаргород|Ямпіль";
